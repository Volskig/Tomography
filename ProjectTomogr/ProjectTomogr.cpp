...
// ProjectTomogr.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProjectTomogrApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CProjectTomogrApp

CProjectTomogrApp::CProjectTomogrApp()
{
...
// Единственный объект CProjectTomogrApp

CProjectTomogrApp theApp;


// Инициализация CProjectTomogrApp

BOOL CProjectTomogrApp::InitInstance()
{
